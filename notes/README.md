...
A first conceptual orientation to the whole body of work.

### 002. Glossary

File:

notes/002-glossary.md
...
Checking term meanings before writing notes, papers, site copy, or public essays.

### 003. Logic Stack

File:

notes/003-logic-stack.md
...
notes/005-subjective-objective-boundary.md

Purpose:

Frames subjectivity as frame-local witness, objectivity as frame-crossing invariance, and bodyhood as bounded relational persistence. Introduces boundary as an admissibility surface.
...
notes/006-claim-types-and-boundary-discipline.md

Purpose:

Separates philosophical proposals, formal definitions, finite graph theorems, computational verifications, experiments, visual witnesses, physical analogies, speculative bridges, public metaphors, naming conventions, and locked terminology.

Best for:

Preventing overclaiming and keeping proof status explicit across the whole project.

## Suggested reading order

1. Read the foundation note.
2. Read the glossary.
3. Read the subjective/objective boundary note for the philosophical core.
4. Read the logic stack note for formal direction.
5. Read the positioning note for philosophical context.
6. Read the claim-types note before writing public material or technical claims.
